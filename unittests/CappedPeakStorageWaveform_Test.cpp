/*
 * CappedPeakStorageWaveform_Test.cpp
 *
...
BOOST_AUTO_TEST_SUITE(CappedPeakStorageWaveform_Test)


BOOST_AUTO_TEST_CASE(construction)
{
	CappedPeakStorageWaveform<int16_t> w;
}

BOOST_AUTO_TEST_CASE(beforeCompaction)
{
	CappedPeakStorageWaveform<int16_t> w(4);
